...
while True:
    ...
    greyscale_frame = cv2.ctvColor(frame, cv2.COLOR_BGR2GRAY)
    ...
    greyscale_image = cv2.blur_frame
    ...
    for c in cnt:
        if cv2.contourArea(c) > 800:
            ...
            cv2.rectangle(franme, (x,y), (x+w, y+h), (0, 255, 0) 2)
    ...
    cv2.putText(frame, datetime.datetime.now().strftime('%A %d %Y %I:%M:%S%p'), (10, frame.shape[0] - 10), font, 0.35, (0,0,255),1)
